<template>
  <el-dialog
    ...
    :title="props.isEditMode ? '编辑菜单/权限' : '创建菜单/权限'"
    :width="deviceDetection() ? '90%' : '50%'"
    @open="handleOpen"
    @close="handleCancel"
  >
    <!-- 通用表单 -->
    ...
    >
      ...
      <el-form-item label="显示父级" prop="showParent">
        <el-switch
          v-model="menuMetaData.showParent"
          :active-value="true"
          :inactive-value="false"
        />
      </el-form-item>
      <el-form-item label="页面缓存" prop="keepAlive">
        <el-switch
          v-model="menuMetaData.keepAlive"
          :active-value="true"
          :inactive-value="false"
        />
      </el-form-item>
      <el-form-item label="标签隐藏" prop="hiddenTag">
        <el-switch
          v-model="menuMetaData.hiddenTag"
          :active-value="true"
          :inactive-value="false"
        />
      </el-form-item>
